 ...
 *
 * <p>This is the entry point for the persisted object graph.
 *
 * <p>The data is divided into four sections:
 *
 * <ul>
 *   <li>{@link Books}
 *   <li>{@link Shops}
 ...
 * </ul>
 *
 * @see <a href="https://manual.docs.microstream.one/data-store/root-instances">MicroStream
 *     Reference Manual</a>
 */
public class Data {
  ...
  public DataMetrics populate(
      final RandomDataAmount initialDataSize, final EmbeddedStorageManager storageManager) {
    return new RandomDataGenerator(
            this.books, this.shops, this.customers, this.purchases, initialDataSize, storageManager)
        .generate();
  }
}
