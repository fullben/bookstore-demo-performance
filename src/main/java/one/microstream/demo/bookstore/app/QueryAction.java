...
public interface QueryAction extends Action {
  ...
  static QueryAction New(
      final String description, final Runnable msQuery, final Runnable jpaQuery) {
    return new Default(description, msQuery, jpaQuery);
  }

  class Default implements QueryAction, Runnable {
    private final String description;
    private final Runnable msQuery;
    private final Runnable jpaQuery;
    private QueryStats queryStats;

    Default(final String description, final Runnable msQuery, final Runnable jpaQuery) {
      super();
