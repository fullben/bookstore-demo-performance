...
public class AuthorRepositoryImpl extends BaseRepositoryImpl<AuthorEntity> {
  ...
  @Transactional
  @Override
  public void batchInsert(final Collection<AuthorEntity> entities) {
    this.batchInsert(
        entities,
        (ps, entity) -> {
  ...
  protected String insertSql() {
    return "INSERT INTO AUTHOR " + "(ID,NAME,ADDRESS_ID) " + "VALUES(?,?,?)";
  }

  @Override
  protected String copySql() {
    return "COPY AUTHOR " + "(ID,NAME,ADDRESS_ID)";
  }
}
