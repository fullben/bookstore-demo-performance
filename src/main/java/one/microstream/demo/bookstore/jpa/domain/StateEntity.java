...
public class StateEntity extends NamedEntity {
  ...
  public StateEntity(final String name, final CountryEntity country) {
    super(name);
  ...
  public CityEntity addCity(final CityEntity city) {
    this.getCities().add(city);
    city.setState(this);
    return city;
  }

  public CityEntity removeCity(final CityEntity city) {
