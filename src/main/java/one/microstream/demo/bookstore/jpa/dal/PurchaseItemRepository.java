...
public interface PurchaseItemRepository extends BaseRepository<PurchaseItemEntity> {
  ...
  @Query(
      "SELECT new one.microstream.demo.bookstore.jpa.dal.BookSales("
          ...
          + "GROUP BY p.book "
          + "ORDER BY bookAmount DESC")
  List<BookSales> bestSellerList(@Param("year") int year);
  ...
  @Query(
      "SELECT new one.microstream.demo.bookstore.jpa.dal.BookSales("
          ...
          + "GROUP BY p.book "
          + "ORDER BY bookAmount DESC")
  List<BookSales> bestSellerList(@Param("year") int year, @Param("country") CountryEntity country);
  ...
  Double revenueOfShopInYear(@Param("shop") ShopEntity shop, @Param("year") int year);
}
