...
public class PublisherRepositoryImpl extends BaseRepositoryImpl<PublisherEntity> {
  ...
  @Transactional
  @Override
  public void batchInsert(final Collection<PublisherEntity> entities) {
    this.batchInsert(
        entities,
        (ps, entity) -> {
  ...
  protected String insertSql() {
    return "INSERT INTO PUBLISHER " + "(ID,NAME,ADDRESS_ID) " + "VALUES(?,?,?)";
  }

  @Override
  protected String copySql() {
    return "COPY PUBLISHER " + "(ID,NAME,ADDRESS_ID)";
  }
}
