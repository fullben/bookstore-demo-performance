...
public class CustomerRepositoryImpl extends BaseRepositoryImpl<CustomerEntity> {
  ...
  @Transactional
  @Override
  public void batchInsert(final Collection<CustomerEntity> entities) {
    this.batchInsert(
        entities,
        (ps, entity) -> {
  ...
  protected String insertSql() {
    return "INSERT INTO CUSTOMER " + "(ID,NAME,ADDRESS_ID) " + "VALUES(?,?,?)";
  }

  @Override
  protected String copySql() {
    return "COPY CUSTOMER " + "(ID,NAME,ADDRESS_ID)";
  }
}
